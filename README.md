# NOvA
This repository contains some of the sample codes related to NOvA.
...
PeripheralNumu codes are also related to another dissertation project. They are written using C++ based CAFAna and ROOT framework. 
